...
KNOWN_NAME_DEVIATIONS = {
    ...
    # fork-only: a deliberate second-instance module (control_center/tr_control.py
    # imports it as a separate module to drive a second Keysight scope with its own
    # config) that shares the base class name Keysight_2000_Xseries.
    "Keysight_2000_Xseries_2": "class is Keysight_2000_Xseries; intentional "
                               "second-instance module, callers use that class name",
}
