...
pb.pulser_pulse(name = 'P0', channel = 'MW', start = '100 ns', length = '12 ns', delta_start = '100 ns')
#pb.pulser_pulse(name = 'P1', channel = 'AWG', start = '0 ns', length = '32 ns', phase_list =  ['+x', '+x'])
pb.pulser_pulse(name = 'P1', channel = 'MW', start = '294 ns', length = '160 ns', delta_start = '2 ns')
pb.pulser_pulse(name = 'P2', channel = 'TRIGGER', start = '600 ns', length = '100 ns', delta_start = '4 ns')
