...
class MainWindow(QMainWindow):
    ...
    def design(self):
        ...
        self.setWindowTitle("ED Measurement")
        ...
        # ---- Labels & Inputs ----
        labels = [("Pi/2 Length", "label_1"), ("Tau", "label_2"), ("Repetition Rate", "label_3"), ("Start Field", "label_4"),  ("End Field", "label_5"), ("Field Step", "label_6"), ("Acquisitions", "label_7"), ("Number of Scans", "label_8"), ("Experiment Name", "label_9"), ("Curve Name", "label_10"), ("Progress", "label_11")]
        ...
        double_boxes = [(QDoubleSpinBox, "box_length", "cur_length", self.pulse_length, 3.2, 1900, 19.2, 3.2, 1, " ns"),
                      ...
                      (QDoubleSpinBox, "box_st_field", "cur_st_field", self.start_field, 0, 15000, 3000, 1, 1, " G"),
                      (QDoubleSpinBox, "box_end_field", "cur_end_field", self.end_field, 0, 15000, 4000, 1, 1, " G"),
                      (QDoubleSpinBox, "box_step_field", "cur_step_field", self.step_field, 0.01, 50, 0.5, 0.1, 2, " G"),
        ...
        # ---- Text Edits ----
        text_edit = [("ED", "text_edit_exp_name", "cur_exp_name", self.exp_name),
        ...
        gridLayout.addWidget(self.box_rep_rate, 2, 1)

        gridLayout.addWidget(hline(), 3, 0, 1, 2)

        gridLayout.addWidget(self.label_4, 4, 0)
        gridLayout.addWidget(self.box_st_field, 4, 1)
        gridLayout.addWidget(self.label_5, 5, 0)
        gridLayout.addWidget(self.box_end_field, 5, 1)
        gridLayout.addWidget(self.label_6, 6, 0)
        gridLayout.addWidget(self.box_step_field, 6, 1)
    ...
    def start(self):
        ...
        self.exp_process = Process( target = self.worker.exp_on, args = ( self.child_conn, self.cur_curve_name, self.cur_exp_name, self.cur_delta, self.cur_length, self.cur_st_field, self.cur_rep_rate, self.cur_scan, self.cur_end_field, self.cur_step_field, self.cur_averages, ) )
