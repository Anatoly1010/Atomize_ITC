...
class MainWindow(QMainWindow):
    ...
    def run_main_experiment(self):
        ...
        self.exp_process = Process( target = worker.exp_on, args = ( self.child_conn, self.cur_curve_name, self.cur_exp_name, self.cur_delta, self.cur_length, self.cur_st_field, self.cur_rep_rate, self.cur_scan, self.cur_end_field, self.cur_step_field, self.cur_averages, ) )
