...
class MainWindow(QMainWindow):
    ...
    def design(self):
        ...
        # ---- Labels & Inputs ----
        labels = [("Pi/2 Length", "label_1"), ("Tau", "label_2"), ("T", "label_3"), ("Time Step", "label_4"), ("Repetition Rate", "label_5"), ("Magnetic Field", "label_6"), ("Points", "label_7"), ("Acquisitions", "label_8"), ("Number of Scans", "label_9"), ("Experiment Name", "label_10"), ("Curve Name", "label_11")]
        ...
        double_boxes = [(QDoubleSpinBox, "box_length", "cur_length", self.pulse_length, 3.2, 1900, 19.2, 3.2, 1, " ns"),
                      (QDoubleSpinBox, "box_delta", "cur_delta", self.delta, 44.8, 640000, 288, 3.2, 1, " ns"),
                       (QDoubleSpinBox, "box_delta_echo", "cur_delta_echo", self.delta_echo, 44.8, 256000, 57.6, 3.2, 1, " ns"),
                      (QDoubleSpinBox, "box_time_step", "cur_step", self.time_step, 3.2, 5.12e6, 6.4, 3.2, 1, " ns"),
        ...
        # ---- Text Edits ----
        text_edit = [("3pESEEM", "text_edit_exp_name", "cur_exp_name", self.exp_name),
        ...
        gridLayout.addWidget(self.button_start, 15, 0)
        gridLayout.addWidget(self.button_stop, 16, 0)
        gridLayout.addWidget(self.button_off, 17, 0)
    ...
    def start(self):
        ...
        self.exp_process = Process( target = self.worker.exp_on, args = ( self.child_conn, self.cur_curve_name, self.cur_exp_name, self.cur_delta, self.cur_length, self.cur_step, self.cur_rep_rate, self.cur_scan, self.cur_field, self.cur_points, self.cur_averages, self.cur_delta_echo, ) )
...
class Worker(QWidget):
    ...
    def exp_on(self, conn, p1, p2, p3, p4, p5, p6, p7, p8, p9, p10, p12):
        ...
        try:
            ...
            #unused option for different phase cycling:
            p13 = 0
            # PULSES
            REP_RATE = str(p6) + ' Hz'
