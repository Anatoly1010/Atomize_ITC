...
class Keysight_3000_Xseries:
    config_file = 'Keysight_3000_Xseries_config.ini'
    ...
    def __init__(self):
        ...
        self.path_config_file = cutil.config_path(self.path_current_directory,
                            self.config_file, legacy = 'Keysight_3034t_config.ini')
    ...
    def oscilloscope_demodulate(self, arr_i, arr_q, freq, ph = None, ph1 = None, ph2 = None, integral = False):
        ...
        dt = pg.siEval( self.oscilloscope_time_resolution() )   # seconds per point
        ...
        if not integral:
            ...
            scale = dt                              # seconds per point (matches oscilloscope_get_curve integral)
