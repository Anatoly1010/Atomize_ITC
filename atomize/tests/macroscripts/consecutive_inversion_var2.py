...
for i in range(POINTS):
    ...
    e0 = inv.experiment_no_wurst( MW_freq = int(freq), Averages = AVERAGES, FREQ = sine_freq, MF = START_FIELD )
    e1 = inv.experiment_wurst( MW_freq = int(freq), Averages = AVERAGES, FREQ = sine_freq, MF = START_FIELD, wurst_center = START_WURST_CENTER)
...
#    data[i] = inv.experiment_double_wurst( MF = mf, Averages = 35)
