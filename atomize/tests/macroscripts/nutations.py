...
def experiment( MF = 3445, MW_freq = 9544, \
                Averages = 120, path_to_file = '/home/pulseepr/Experimental_Data/auto_nutation.csv' ):
    ...
    file_handler.save_data(path_to_file, data, header = header, mode = 'w')
